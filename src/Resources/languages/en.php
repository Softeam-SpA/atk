...
return [
    ...
    'auth_missingusername' => 'Please enter username and password.',
    'auth_no_server' => 'No server specified. No authentication possible (please consult your system administrator).',
    'auth_passwordmail_explanation' => 'You receive this email because you used the password forgotten function. Below are your new login data:',
    'auth_passwordmail_sent' => 'If the given username exists, a new password is sent to the corresponding email address.',
    ...
    'error_fileexists' => 'File already exists on server, please rename it',
    'error_file_mime_type' => 'Invalid file type',
    ...
    'error_file_image_size_width' => "The file width exceedes the maximum allowed value",
    'error_file_image_size_height' => "The file height exceedes the maximum allowed value",
    ...
    'error_iconv_not_install' => 'iconv module is not installed on your system',
    'error_invalid_email' => 'Invalid email address',
    'error_missing_param' => "Missing param '%s'",
    ...
    'export' => 'Export',
    'export_config_explanation' => 'Options for the CSV export',
    'export_generatetitlerow' => 'Header row',
    'export_selectcolumns' => 'Fields to export',
    ...
    'feedback_download_file_attribute_failed' => 'The file could not be downloaded.',
    'feedback_download_file_attribute_success' => 'The file has been downloaded.',
    'feedback_edit_failed' => 'The item could not be edited.',
    ...
    'feedback_view_failed' => 'The item could not be viewed.',
    ...
    'menu' => 'Menu',
    'menu_main' => 'Main',
    'minutes' => 'm', // (used in atkDurationAttribute)
    'mon' => 'Mon',
    'monday' => 'Monday',
    ...
    'otp_error_expired' => 'The verification code has expired. Please log in again.',
    'otp_error_mismatch' => 'The verification code is not correct. Please try again.',
    'otp_error_maxattempts' => 'Too many wrong attempts. Please log in again.',
    'otp_error_noemail' => 'No e-mail address is associated with your user, so the verification code cannot be sent. Please contact the administrator.',
    'otp_error_send' => 'The verification code could not be sent. Please try again later or contact the administrator.',
    'otp_form_description' => 'We have sent a verification code to your e-mail address. Enter it to complete the login.',
    'otp_form_title' => 'Two-step verification',
    'otp_mail_body' => "Your verification code is: {otp}\n\nThe code is valid for {minutes} minutes.\nIf you did not try to log in, please ignore this message.",
    'otp_mail_subject' => 'Verification code',
    ...
    'pf_check_all' => 'All',
    'pf_check_none' => 'None',
    'pf_invert_selection' => 'Invert selection',
    'previous' => 'Previous',
    ...
    'saveandedit' => 'Save and continue',
    'saveandnext' => 'Save and new',
    ...
    'tue' => 'Tue',
    'tuesday' => 'Tuesday',
    'u2f_error' => 'An error has occurred processing your login, please try again',
    'u2f_errorcode_1' => 'An error has occurred processing your login, please try again',
    'u2f_errorcode_2' => 'The authentication request is incorrect. Be sure to use the https protocol, otherwise please contact the administrator.',
    'u2f_errorcode_3' => 'Client configuration is not supported',
    'u2f_errorcode_4' => 'The presented device is not eligible for this request',
    'u2f_errorcode_5' => 'Timeout reached before request could be satisfied, please try again',
    'u2f_form_title' => 'U2F Authentication',
    'u2f_form_description' => "<p><strong>Insert your security key to use it.</strong></p><p>After inserting, tap your key if it has a button or gold disk.</p>",
